...
const handler = async (event) => {
  try {
    ...
    if (postType == "Facebook" && post.subtitle.length != 0) {
      ...
      const captionUrl = `https://graph-video.facebook.com/v19.0/787520133338543/captions?access_token=${accessToken}&default_locale=none&locales_to_delete=[]`;
...
handler({
  ...
  post: {
    ...
    accessToken:
      "EAAU579TDpf0BOyAdmGGBVXaS1ZBZAJMEIvhuveZA1DiP2zQ1zDJcQXqWefVq1ZCxmdZCkcYQBLFx16OQqtECrXOhBgToWXZBjzrvmviMcTAUZAfUzglhbCD896hr6rsWLmZBQ0HlawDRtqDMTnPcl4HcgF3rOngmhMBMA4oZAIF16W9YCnsXSXsVHZCeV1mcA4apSeigGOA8Win92KzZA4ZD",
    media: {
